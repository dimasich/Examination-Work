...
buttonGet.addEventListener("click", function(){
    ...
    console.log(pars);
            ...
            decode.empty();
                ...
                pole.append('<div><span class="uk-label">' +  pars.rooms[q].messages[i].nick +'</span>'+ " : "+ pars.rooms[q].messages[i].textChat+'</div>');
                decode.append('<div><span class="uk-label">' +  pars.rooms[q].messages[i].nick +'</span>'+ " : "+ code(pars.rooms[q].messages[i].textChat, key.value, true)+'</div>');
                pole.scrollTop(1000000);
                decode.scrollTop(1000000);
